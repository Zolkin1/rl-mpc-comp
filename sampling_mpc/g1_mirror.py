...
from sampling_mpc.mirror_task import MirrorTask
...
dl.create_segment("test1", 0, 1000)
task = MirrorTask(dl)
...
mj_data.qpos[:] = task._get_reference_configuration(0)
...
run_interactive(
    ...
    frequency=100,
    show_traces=False,
    reference=reference,  # TODO: Adjust the data here to have the right quaternion convention
)